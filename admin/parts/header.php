...
<body class="d-flex flex-column h-100">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="<?= $_SERVER['PHP_SELF'] != '/index.php' ? '../' : '' ?>index.php">Navbar</a>
      ...
      <ul class="navbar-nav">
        ...
        ?>
          <li class="nav-item <?= $_SERVER['PHP_SELF'] == '/views/register.php' ? 'active' : '' ?>">
            <a class="nav-link" href="<?= $_SERVER['PHP_SELF'] == '/index.php' ? 'views/' : '' ?>register.php" role="button" aria-haspopup="true" aria-expanded="false">Inscription</a>
          </li>
          <li class="nav-item <?= $_SERVER['PHP_SELF'] == '/views/login.php' ? 'active' : '' ?>">
            <a class="nav-link" href="<?= $_SERVER['PHP_SELF'] == '/index.php' ? 'views/' : '' ?>login.php" role="button" aria-haspopup="true" aria-expanded="false">Connexion</a>
          </li>
        ...
        ?>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item" href="profileModification.php?view=profileModification">Modifier son profil</a>
