...
<body class="d-flex flex-column h-100 <?= $_SERVER['PHP_SELF'] == '/views/errors/404.php' ? 'error' : ' ' ?>">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item <?= $_SERVER['PHP_SELF'] == '/views/rechercher.php' ? 'active' : '' ?>">
          <a class="nav-link" href="/proj/rechercher.php" role="button" aria-haspopup="true" aria-expanded="false">Rechercher</a>
        </li>
        <li class="nav-item <?= $_SERVER['PHP_SELF'] == '/views/guides.php' ? 'active' : '' ?>">
          <a class="nav-link" href="/proj/Guides.php" role="button" aria-haspopup="true" aria-expanded="false">Acheter</a>
        </li>
        <li class="nav-item <?= $_SERVER['PHP_SELF'] == '/views/guides.php' ? 'active' : '' ?>">
          <a class="nav-link" href="/proj/Guides.php" role="button" aria-haspopup="true" aria-expanded="false">Vendre</a>
        </li>
        <li class="nav-item <?= $_SERVER['PHP_SELF'] == '/views/guides.php' ? 'active' : '' ?>">
          <a class="nav-link" href="/proj/Guides.php" role="button" aria-haspopup="true" aria-expanded="false">Louer</a>
        </li>
      </ul>
      <ul class="navbar-nav">
        ...
        ?>
          <li class="nav-item <?= $_SERVER['PHP_SELF'] == '/views/register.php' ? 'active' : '' ?>">
            <a class="nav-link" href="/proj/inscription" role="button" aria-haspopup="true" aria-expanded="false">Inscription</a>
          </li>
          <li class="nav-item <?= $_SERVER['PHP_SELF'] == '/views/login.php' ? 'active' : '' ?>">
            <a class="nav-link" href="/proj/connexion" role="button" aria-haspopup="true" aria-expanded="false">Connexion</a>
          </li>
